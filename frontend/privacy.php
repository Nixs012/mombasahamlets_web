...
<head>
    ...
    <title>Privacy Policy - Mombasa Hamlets FC</title>
    <meta name="description"
        content="Learn how Mombasa Hamlets FC collects, uses, and protects your personal information. Read our comprehensive privacy policy.">
    ...
    <main>
        ...
        <section class="hero">
            <div class="hero-content">
                ...
                <p>How we protect and use your information at Mombasa Hamlets FC</p>
            </div>
        </section>
        ...
        <div class="privacy-container">
            ...
            <div class="policy-section">
                <h2>Introduction</h2>
                <p>Welcome to Mombasa Hamlets FC's Privacy Policy. This policy describes how we collect, use, and share
                    your personal information when you visit our website, use our services, or interact with us in other
                    ways.</p>
                <p>We are committed to protecting your privacy and ensuring that your personal information is handled in
                    a safe and responsible manner. This policy outlines our practices regarding your personal data.</p>
            </div>
            ...
            <div class="policy-section">
                ...
                <p>We use cookies and similar tracking technologies to track activity on our website and store certain
            ...
            <div class="policy-section">
                ...
                <ul>
                    <li><strong>Service Providers:</strong> Third parties who provide services on our behalf (payment
                        processing, data analysis, email delivery)</li>
                    <li><strong>Business Partners:</strong> Trusted partners who offer products or services we think may
                        interest you</li>
            ...
            <div class="policy-section">
                <h2>Data Security</h2>
                <p>We have implemented appropriate security measures to prevent your personal data from being
                    accidentally lost, used, or accessed in an unauthorized way. These include:</p>
                <ul>
                    <li>Secure server infrastructure with encryption</li>
                    <li>Regular security assessments and testing</li>
                    <li>Limited access to personal data on a need-to-know basis</li>
                    <li>Procedures to deal with any suspected personal data breach</li>
                </ul>

                <p>While we strive to use commercially acceptable means to protect your personal information, no method
            ...
            <div class="policy-section">
                ...
                <ul>
                    ...
                    <li><strong>Restriction:</strong> The right to request limiting the processing of your personal data
                    </li>
                    <li><strong>Data Portability:</strong> The right to request transfer of your data to another
                        organization</li>
                    <li><strong>Objection:</strong> The right to object to processing of your personal data</li>
                </ul>

                <p>To exercise any of these rights, please contact us using the details provided in the "Contact Us"
                    section.</p>
            </div>
            ...
            <div class="policy-section">
                ...
                <p>Our website is not intended for children under 13 years of age. We do not knowingly collect personal
                    ...
                    information from your child, please contact us immediately.</p>
            </div>
            ...
            <div class="policy-section contact-privacy">
                <h2>Contact Us</h2>
                <p>If you have any questions about this Privacy Policy, please contact us:</p>
                <p>Email: privacy@mombasahamletsfc.co.ke</p>
